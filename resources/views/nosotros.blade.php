...
¡Vamos volando! llega el tecnico a la puerta de tu casa.</p>
   ...
   <div class="team">
        <div class="text-center wow fadeInDown">
          ...
          <p>La clave del éxito esta en detectar hacia dónde va el mundo y llegar ahí primeros.</p>
        </div>
        ...
        <div class="row clearfix">
          <div class="col-md-4 col-sm-6">
            <div class="single-profile-top wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
              <div class="media">
                <div class="pull-left">
                  <a href="#"><img class=" " src="img/man1.jpg" alt=""></a>
                </div>
                <div class="media-body">
                  <h4>Enrique De La Fuente</h4>
...
<div class="row clearfix">
          <div class="col-md-4 col-sm-6">
            <div class="single-profile-top wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
              <div class="media">
                <div class="pull-left">
                  <a href="#"><img class=" " src="img/vale.jpg" alt=""></a>
                </div>
                <div class="media-body">
                  <h4>Valentina Amaya</h4>
 ...
 <div class="row clearfix">
          <div class="col-md-4 col-sm-6">
            <div class="single-profile-top wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
              <div class="media">
                <div class="pull-left">
                  <a href="#"><img class=" " src="img/man3.jpg" alt=""></a>
                </div>
                <div class="media-body">
                  <h4>Davis Bizama</h4>
                  <h5>Base de datos</h5>
